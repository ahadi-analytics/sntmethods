...
Thanks for using sntmethods! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/ahadi-analytics/sntmethods/issues/new).
...
requests](https://github.com/ahadi-analytics/sntmethods/issues) to make
...
To be as efficient as possible, development tends to be bursty, so you
shouldn’t worry if you don’t get an immediate response. This process
makes a good reprex particularly important because it might be some time
between your initial report and when we start working on it. If we can’t
reproduce the bug, we can’t fix it!
