...
This outlines how to propose a change to sntmethods. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ahadi-analytics/sntmethods", fork = TRUE)`.
...
Please note that the sntmethods project is released with a [Contributor
Code of
Conduct](https://ahadi-analytics.github.io/sntmethods/CODE_OF_CONDUCT.md).
