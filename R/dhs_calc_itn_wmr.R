#' Calculate WMR ITN Indicators from DHS Data
#'
#' Computes the full set of WMR (World Malaria Report) ITN indicators
#' from DHS Household Records (HR) and Person Records (PR) data. Returns
#' survey-weighted proportions with logit confidence intervals in WMR long
#' format.
#'
#' @details
#' Computes up to 42+ ITN indicators following WMR methodology, organised in
...
#'   (default), computes all indicators from [itn_wmr_dictionary()].
...
#'
#' @seealso [itn_wmr_dictionary()] for indicator definitions,
#'   [calc_itn_dhs_core()] for the legacy wide-format output
#' @export
calc_itn_wmr <- function(
  dhs_hr,
  dhs_pr,
  survey_vars = list(
    cluster   = "hv001",
...
#' Compute a single ITN WMR indicator
#'
...
# =============================================================================
# WMR ITN Indicator Dictionary
# =============================================================================

#' ITN WMR Indicator Dictionary
#'
#' Returns the full dictionary of WMR ITN indicators with metadata.
#'
...
#'
#' @export
itn_wmr_dictionary <- function() {
  conds <- .itn_wmr_conditions()
  tibble::tibble(
...
#' Internal: ITN WMR indicator conditions
#'
#' Returns list of 42 indicator specifications for ITN WMR indicators.
#' 6 categories x 7 subgroups each.
#'
#' @return List of named lists.
#' @noRd
.itn_wmr_conditions <- function() {
